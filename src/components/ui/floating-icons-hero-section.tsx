...
const Icon = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="flex items-center justify-center w-16 h-16 md:w-20 md:h-20 p-1.5 rounded-3xl shadow-xl bg-white/95 backdrop-blur-sm border border-black/10"
        animate={{
          y: [0, -8, 0, 8, 0],
          x: [0, 6, 0, -6, 0],
          rotate: [0, 5, 0, -5, 0],
      ...
      >
        <IconComponent className="w-14 h-14 md:w-16 md:h-16" />
      </motion.div>
    </motion.div>
  );
};
