...
export function FinalCTA() {
  ...
  return (
    <div className="w-full bg-background text-foreground py-16 sm:py-20 flex items-center justify-center px-6 overflow-hidden">
      <div className="w-full max-w-7xl animate-fade-in-up">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          {/* Right Marquee */}
          <div ref={marqueeRef} className="relative h-[420px] lg:h-[520px] flex items-center justify-center animate-fade-in-up [animation-delay:400ms]">
