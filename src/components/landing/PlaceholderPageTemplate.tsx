...
export function PlaceholderPageTemplate({
  title,
  lastUpdated,
  children,
  className,
    ...
    >
      <div className="mx-auto max-w-[900px]">
        <nav className="mb-6 text-sm text-slate-500">
          <Link href="/" className="text-blue-600 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-200 rounded">
            Home
          </Link>
        </nav>
        <div
          className={cn(
            "rounded-3xl border border-blue-100/70 bg-white/75 p-8 shadow-[0_20px_60px_rgba(37,99,235,0.10)] backdrop-blur-xl",
            className
          )}
        >
          ...
          <div className="mt-6 text-slate-700">
            {children ?? (
              <p className="text-slate-600">
                This page is coming soon. Check back later or{" "}
